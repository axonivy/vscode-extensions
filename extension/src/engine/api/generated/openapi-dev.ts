 ...
 */
export const paged = <TData = AxiosResponse<WebNotificationBean[]>>(params?: PagedParams, options?: AxiosRequestConfig): Promise<TData> => {
 ...
 */
export const hideAll = <TData = AxiosResponse<unknown>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.delete(`/notifications`, options);
};

/**
 * Returns the total and unread size of web notifications for the current user.
 */
export const head = <TData = AxiosResponse<void>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.head(`/notifications`, options);
};
...
export const operation = <TData = AxiosResponse<unknown>>(
  webNotificationOperation: WebNotificationOperation,
  options?: AxiosRequestConfig
): Promise<TData> => {
  return axios.patch(`/notifications`, webNotificationOperation, options);
};

/**
 * Returns the web notification for the current user with the given uuid
 */
export const get = <TData = AxiosResponse<WebNotificationBean>>(uuid: string, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/notifications/${uuid}`, options);
};

/**
 * Hides the web notification for the current user and the given uuid.
 */
export const hide = <TData = AxiosResponse<unknown>>(uuid: string, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.delete(`/notifications/${uuid}`, options);
};
...
export const operation1 = <TData = AxiosResponse<unknown>>(
  ...
  return axios.patch(`/notifications/${uuid}`, webNotificationOperation, options);
};

/**
 * Returns the current user.
 */
export const me = <TData = AxiosResponse<UserBean>>(options?: AxiosRequestConfig): Promise<TData> => {
 ...
 */
export const stats = <TData = AxiosResponse<AggBean>>(params: StatsParams, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/cases/stats`, {
    ...options,
    params: { ...params, ...options?.params }
  });
};

export const add = <TData = AxiosResponse<MessageBean>>(caseId: number, addBody: AddBody, options?: AxiosRequestConfig): Promise<TData> => {
  const formData = new FormData();
  if (addBody.file !== undefined) {
    formData.append('file', addBody.file);
  }

  return axios.post(`/workflow/case/${caseId}/document`, formData, options);
};
...
export const getContent = <TData = AxiosResponse<unknown>>(
  ...
  return axios.get(`/workflow/case/${caseId}/document/${documentId}`, options);
};
...
export const _delete = <TData = AxiosResponse<MessageBean>>(
  ...
  return axios.delete(`/workflow/case/${caseId}/document/${documentId}`, options);
};
 ...
 * @deprecated
 */
export const get1 = <TData = AxiosResponse<ProcessStartBean[]>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/processstarts`, options);
};

/**
 * Returns all web startables that can be started by the current user.
 */
export const paged1 = <TData = AxiosResponse<WebStartableBean[]>>(params?: Paged1Params, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/startables`, {
    ...options,
    params: { ...params, ...options?.params }
  });
};
 ...
 */
export const head1 = <TData = AxiosResponse<void>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.head(`/workflow/startables`, options);
};

/**
 * Returns the number of tasks the current user can work on.
 */
export const count = <TData = AxiosResponse<number>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/tasks/count`, options);
};

/**
 * Returns the tasks the current user can work on.
 */
export const getTasks = <TData = AxiosResponse<TaskBean[]>>(options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/tasks`, options);
};

/**
 * Returns the task with the given task identifier.
 */
export const getTask = <TData = AxiosResponse<TaskBean>>(taskId: number, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/task/${taskId}`, options);
};

/**
 * Returns the locations of the task with the given taskId.
 */
export const getLocations = <TData = AxiosResponse<LocationBean>>(taskId: number, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/task/${taskId}/locations`, options);
};

/**
 * Returns task statistics.
 */
export const stats1 = <TData = AxiosResponse<AggBean>>(params: Stats1Params, options?: AxiosRequestConfig): Promise<TData> => {
  return axios.get(`/workflow/tasks/stats`, {
    ...options,
    params: { ...params, ...options?.params }
  });
};
